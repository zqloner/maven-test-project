package com.zq.pdf.newPdfUtil;

/**
 * @Description:
 * @Author: zhangqi
 * @CreateTime: 2020/7/3016:13
 * @Company: MGL
 */
...
//原文地址：  https://blog.csdn.net/weixin_37848710/article/details/89522862
...
//        第二张图片
        Image image2 = Image.getInstance("D:\\图片或者视频\\李嘉欣\\1.jpg");
//        设置图片位置
...
//        添加第二张图片
        document.add(image2);
        document.add(new Paragraph("测试换行第一行"));
        document.add(new Paragraph("测试换行第二行"));
//        换行
        document.add(new Paragraph("\n"));
        document.add(new Paragraph("测试换行第三行"));
        document.add(new Paragraph("测试换行第四行"));
    }
